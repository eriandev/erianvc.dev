<script>
    ...
    let navbar
    let projects, posts, about, contact
    ...
    afterUpdate(() => switchOnview())
</script>

<nav class:hidden={navbar}>
    <ul>
        <li class:onview={projects}>
            <Link to="projects" class="flex flex-wrap justify-center">
        ...
        <li class:onview={posts}>
            <Link to="posts" class="flex flex-wrap justify-center">
                <svg role="img" viewBox="0 0 24 24">
                    <title>Posts</title>
        ...
        <li class:onview={about}>
            <Link to="about" class="flex flex-wrap justify-center">
                <svg role="img" viewBox="0 0 24 24">
                    <title>About</title>
        ...
        <li class:onview={contact}>
            <Link to="contact" class="flex flex-wrap justify-center">
                <svg role="img" viewBox="0 0 24 24">
                    <title>Contact</title>
