<script>
    ...
    afterUpdate(() => isNavbarHidden = segment ? false : true)
</script>

<nav class:hidden={isNavbarHidden}>
    <ul>
        <li aria-current={segment === 'projects' ? 'page' : null}>
            <Link to="projects" class="flex flex-wrap content-center justify-center w-full h-full">
        ...
        <li aria-current={segment === 'posts' ? 'page' : null}>
            <Link to="posts" class="flex flex-wrap content-center justify-center w-full h-full">
                <svg role="img" viewBox="0 0 24 24">
                    <title>Posts</title>
        ...
        <li aria-current={segment === 'about' ? 'page' : null}>
            <Link to="about" class="flex flex-wrap content-center justify-center w-full h-full">
                <svg role="img" viewBox="0 0 24 24">
                    <title>About</title>
        ...
        <li aria-current={segment === 'contact' ? 'page' : null}>
            <Link to="contact" class="flex flex-wrap content-center justify-center w-full h-full">
                <svg role="img" viewBox="0 0 24 24">
                    <title>Contact</title>
