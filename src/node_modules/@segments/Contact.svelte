<script>
    ...
    onMount(() => clickTap = 'touchstart' in window ? 'Tap' : 'Click')
</script>
...
<section class="contact">
    <div class="container">
        ...
        <Text class="mb-12">
            Whether it is a small venture or a complex web application or business software, 
            contact me and we will discuss it thoroughly
        </Text>

        {#if selected}
            <Link external to={QRdata[selected-1].link} btn small outline>
                {QRdata[selected-1].msg}
            </Link>
        {:else}
...
<style>
    section {
        @apply grid min-h-screen text-center;
        place-items: center;
    }
