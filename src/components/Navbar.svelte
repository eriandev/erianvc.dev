<script>
    ...
    const getThreshold = (width, height) =>
            ...
            (entries) => {
                entries.forEach(
                    (entry) =>
                        ...
                        updateOnviewSegment(entry.target.id),
                )
            },
